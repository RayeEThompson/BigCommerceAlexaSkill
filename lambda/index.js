...
function httpGet() {
  return new Promise((resolve, reject) => {
    var options = {
      host: "https://api.bigcommerce.com/stores/ltgn22trch",
      port: 443,
      path: "/v3/catalog/products?include_fields=name&is_featured=1",
      method: "GET",
      headers: {
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput =
      "Welcome, you can say Featured Products or Help. Which would you like to try?";
